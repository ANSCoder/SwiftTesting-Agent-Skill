...
- new patterns in `skill/patterns/`
- new anti-pattern guidance in `skill/anti-patterns/`
- new realistic examples in `skill/examples/`
- migration improvements in `skill/migration/`
